...
class embeds(commands.Cog):
    ...
    async def help_commands(self,ctx):
        embed = nextcord.Embed(title="Ender Bot Commands",description="Note : command sama3ni t5adm ken Song.mp3 or Song2.mp3 5ater bot mazel under development", color=0x008080)
